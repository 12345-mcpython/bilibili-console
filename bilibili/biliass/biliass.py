...
; Danmaku generated by bilibili-console
; https://github.com/12345-mcpython/bilibili-console
Script Updated By: biliass (https://github.com/yutto-dev/biliass) / bilibili-console (https://github.com/12345-mcpython/bilibili-console)
ScriptType: v4.00+
PlayResX: %(width)d
PlayResY: %(height)d
